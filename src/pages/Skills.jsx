...
function Skills() {
    return (
        <>
            ...
            <path fill="transparent" fill-opacity="1" stroke="#393B4E" stroke-width="2" stroke-dasharray="10 5" stroke-dashoffset="0" d="M0,160 C80,130 160,117 240,105 C320,93 400,83 560,97 C720,111 880,149 1040,160 C1200,171 1280,149 1360,122.7 C1400,109.3 1440,96 1440,96"></path>
            </svg>
